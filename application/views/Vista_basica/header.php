      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li  class="<?php if ($titulo=="Inicio  Sesión"){echo "active";}?>"><a style="color:white;" href="<?php echo base_url() ; ?>Sesion/iniciarSesion"><i class="fa fa-sign-in" aria-hidden="true"></i> Iniciar Sesión</a></li>
            <li  class="<?php if ($titulo=="Registro"){echo "active";}?>"><a style="color:white;" href="<?php echo base_url() ; ?>Registro/registrarUsuario">Registrarse</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
