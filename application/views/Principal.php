        ...
        <div class="item active">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-primary" href="<?php echo base_url() ; ?>Planes/Quince" role="button">Quinceaños</a></p>
            </div>
          </div>
        </div>
        <div class="item">
    ...
    <div class="container marketing">
	    ...
	    <div class="row">
	        <div class="col-lg-4">
	          ...
	          <p><a class="btn btn-default" href="<?php echo base_url() ; ?>Planes/Quince" role="button">Ver Planes &raquo;</a></p>
	        </div><!-- /.col-lg-4 -->
	        <div class="col-lg-4">
